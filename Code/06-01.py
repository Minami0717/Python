...
worksheetR.set_column(0,w-1,1.0)
worksheetG.set_column(0,w-1,1.0)
worksheetB.set_column(0,w-1,1.0)

for i in range(h):
    worksheetR.set_row(i,9.5)
    worksheetG.set_row(i,9.5)
    worksheetB.set_row(i,9.5)
